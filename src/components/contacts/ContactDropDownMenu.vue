    ...
    <DropDownMenu>
        ...
        <template v-slot:items>
            ...
            <DropDownMenuItem @click="copyPublicKey(contact)">
                ...
                <span>{{ I18n.t('contactMenu.copyPublicKey') }}</span>
            </DropDownMenuItem>
            ...
            <DropDownMenuItem @click="shareContact(contact)">
                ...
                <span>{{ I18n.t('contactMenu.shareZeroHop') }}</span>
            </DropDownMenuItem>
            ...
            <DropDownMenuItem @click="exportContact(contact)">
                ...
                <span>{{ I18n.t('contactMenu.exportToClipboard') }}</span>
            </DropDownMenuItem>
            ...
            <DropDownMenuItem @click="onResetPath(contact)">
                ...
                <span>{{ I18n.t('contactMenu.resetPath') }}</span>
            </DropDownMenuItem>
            ...
            <DropDownMenuItem v-if="showDeleteMessageHistoryButton" @click="onDeleteMessageHistory">
                ...
                <span class="text-red-500">{{ I18n.t('contactMenu.deleteMessageHistory') }}</span>
            </DropDownMenuItem>
            ...
            <DropDownMenuItem @click="onDeleteContact(contact)">
                ...
                <span class="text-red-500">{{ I18n.t('contactMenu.forgetContact') }}</span>
            </DropDownMenuItem>
    ...
    methods: {
        ...
        async shareContact(contact) {
            try {
                ...
                alert(I18n.t("contactMenu.adverted"));
            } catch(e) {
                console.log(e);
                alert(I18n.t("contactMenu.shareFailed"));
            }
        },
        async exportContact(contact) {
            try {
                ...
                console.log(e);
                alert(I18n.t("contactMenu.exportFailed"));
            }
        },
        async onResetPath(contact) {

            // confirm user wants to reset path
            if(!confirm(I18n.t("contactMenu.resetPathConfirm"))){
                return;
            }
        ...
        async onDeleteMessageHistory() {
            ...
            if(!confirm(I18n.t("contactMenu.deleteHistoryConfirm"))){
                return;
            }
        ...
        async onDeleteContact(contact) {
            ...
            if(!confirm(I18n.t("contactMenu.forgetConfirm"))){
                return;
            }
